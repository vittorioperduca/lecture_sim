...
$\Rightarrow$ we can sample the data distribution under H0 simply by shuffling the case control status: <font color='turquoise'>each permutation is a data replicate</font> 
...
```
* Be careful that the smallest possible p is $1/N$ $\Rightarrow$ in multiple testing $N$ must be very large
